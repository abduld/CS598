...
to be copied into \fix{Allocation} buffers.  The buffer has to be copied back to
...
function and converting to a \fix{Allocation} buffer if what is passed is a Java
array.
...
runtime exception is raised when using with types other than \fix{int32\_t}.
