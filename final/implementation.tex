...
Trpen records the time a message is received (which correspond to time blocks
...
The compile option \fix{-O3 -ftree-vectorize -mvectorize-with-neon-quad}
 is set when compiling native code, this allows opportunity to autovectorization code.