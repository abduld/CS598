...
The \fix{parboil} package is the core of the project. In this package, we also
...
just need to invoke the \fix{Timer.start()} method at the beginning of the execution
...
dumps all the recorded \fix{TimerElement} to the JSON format for conveniently storing
into the database.
