...
automatically computed and recorded. The $Timer$ class also has a function that
dumps all the recorded $TimerElement$ to the JSON format for conveniently storing
into the database.
